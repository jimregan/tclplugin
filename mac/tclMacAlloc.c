 ...
 *
 *      This version is slightly modified for the Tcl Plugin.  It calls
 *      NPN_MEM_FLUSH before each call to TclpSysAlloc, since this seems to
 *      make Netscape a bit happier.
 *      
 *
