...
AC_DEFUN(TCLPLUGIN_MOZILLA_DIR, [
	...
	AC_MSG_ERROR([Mozilla home directory \"$MOZILLA_DIR\" does not exist: use configure --with-mozilla=MOZILLA_HOME - ie. --with-mozilla=$HOME/.netscape for a personal install])
    fi
